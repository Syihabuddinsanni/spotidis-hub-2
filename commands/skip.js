...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        if (!player) return client.sendTime(message.channel, "<a:warn:866161245232693291> | **Nothing is playing right now...**");
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (!player) return client.sendTime(interaction, "<a:warn:866161245232693291> | **Nothing is playing right now...**");
