   ...
   run: async (client, message, args, { GuildDB }) => {
    ...
    let Embed = new MessageEmbed()
            ...
            .addFields( //edit sekarang
              { name: '<:blurple_inbox:867434854529499146> __Images__', value: '> \``avatar | `\`' },
              ...
              { name: '<:blurple_settings:867424376236408832> __Utility__', value: '> `invite` | `stats` | `config` | `ping` | `delete` | `about`' },
